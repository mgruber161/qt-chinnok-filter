//@CodeCopy
//MdStart
namespace QTChinnok.CodeGenApp
{
    ...
    internal partial class Program
    {
        ...
        private static void RunApp()
        {
            ...
            {
                Console.Clear();
                Console.WriteLine($"Code generation for: {nameof(QTChinnok)}");
                Console.WriteLine("=============================================");
                Console.WriteLine();
        ...
        private static string GetCurrentSolutionPath()
        {
            int endPos = AppContext.BaseDirectory
                                   .IndexOf("QTChinnok.CodeGenApp", StringComparison.CurrentCultureIgnoreCase);
