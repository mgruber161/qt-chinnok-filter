...
namespace QTChinnok.Logic.DataContext
{
    ...
    {
#if SQLSERVER_ON
        private static readonly string ConnectionString = "Data Source=(localdb)\\MSSQLLocalDB;Database=QTChinnokDb;Integrated Security=True";
#endif
#if SQLITE_ON
        private static readonly string ConnectionString = "Data Source=/Users/gerhardgehrer/Projects/Data/QTChinnok.db";
#endif
        /// <summary>
