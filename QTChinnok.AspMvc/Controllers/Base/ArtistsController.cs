...
namespace QTChinnok.AspMvc.Controllers.Base
{
    ...
    using TAccessModel = QTChinnok.Logic.Models.Base.Artist;
    using TViewModel = QTChinnok.AspMvc.Models.Base.Artist;
    using TFilterModel = QTChinnok.AspMvc.Models.Base.ArtistFilter;
    using TAccessContract = QTChinnok.Logic.Contracts.Base.IArtistsAccess<QTChinnok.Logic.Models.Base.Artist>;
    ///
    ...
    public sealed partial class ArtistsController : Controllers.FilterGenericController<TAccessModel, TViewModel, TFilterModel, TAccessContract>
    {
        ...
        /// Generated by the generator
        ///
        public ArtistsController(QTChinnok.Logic.Contracts.Base.IArtistsAccess<TAccessModel> other)
        : base(other)
        {
            Constructing();
