...
namespace QTChinnok.AspMvc.Models.App
{
    ...
    public partial class TrackFilter : Models.View.IFilterModel
    {
        ...
        /// Generated by the generator
        ///
        public bool HasEntityValue => AlbumId != null || GenreId != null || MediaTypeId != null || Name != null || Composer != null || Milliseconds != null || UnitPrice != null;
        ...
        public string CreateEntityPredicate()
        {
            ...
            if (Milliseconds != null)
            {
                ...
                result.Append($"(Milliseconds != null && Milliseconds == {Milliseconds})");
            }
            if (UnitPrice != null)
            {
                if (result.Length > 0)
